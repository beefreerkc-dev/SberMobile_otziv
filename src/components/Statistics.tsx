...
export function Statistics({ reviews, weekRange }: StatisticsProps) {
  ...
  return (
    <section className="bg-white rounded-xl shadow-card p-6 mb-6">
      <h2 className="text-lg font-semibold text-sber-dark mb-4">Statistics</h2>
      ...
      {/* Daily trend */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 mb-2">Reviews per day</h3>
        <div className="h-[200px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={dailyData} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
              ...
              <Tooltip />
              <Bar dataKey="count" fill="#2dbd4f" radius={[4, 4, 0, 0]} name="Reviews" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
